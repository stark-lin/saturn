...
Source business modules synchronously maintain the corresponding metadata projection when creating, updating, or deleting objects that affect title/tags/status; soft-deleted Notes retain their `nte-obj` projection with status `deleted`
